...
https://github.com/SV-Zanshin/Cubigel/archive/master.zip and the library wiki is to be found
...
several parts of code which can be somewhat optimized, but in order to make the c++ code more under-
standable by non-programmers some performance has been sacrificed for legibility and
maintainability.
...
1.0.b1 2017-04-18 SV-Zanshin Added hardware serial in addition to software serial
